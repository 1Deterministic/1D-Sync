...
english = {
    ...
    "error_config_log_only_if_an_error_occur": "\tlog_only_if_an_error_occur has an invalid value: ",
    "error_config_log_only_if_a_sync_occur": "\tlog_only_if_a_sync_occur has an invalid value: ",
